...
package crypto.hash
{
    ...
    /**
     * 
     * adapted from: redtamarin/src/test/acceptance/misc/md5_t.as
     */
    public final class md5_t
    {
        ...
        */
        ...
        // md5Bytes() returns the md5 digest of a serie of bytes.
        public static function md5Bytes( input_bytes : ByteArray ) : ByteArray
        {
            // convert bytes to uint Array
            var i : uint;
            var input_block : Array = new Array( input_bytes.length );
            input_bytes.position = 0;
            var byte:uint;
            ...
            var digest_bytes : ByteArray = new ByteArray();
            for( i = 0; i < digest.length; ++i )
            {
                digest_bytes.writeByte( digest[i] );
            }
            
            digest_bytes.position = 0;
            return digest_bytes;
        }
