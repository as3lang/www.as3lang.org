package net
{
    ...
    */
    public class URI
    {
        ...
        public static const MUST_ESCAPE:String = " %";
        
        // Baseline of what characters must be escaped
        public static const BASELINE_ESCAPE:String = MUST_ESCAPE + ":?#/@";
        
        // Characters that must be escaped in the part part.
        public static const PATH_ESCAPE:String = MUST_ESCAPE + "?#";
        ...
        public static const NON_HIERARCHICAL_ESCAPE:String = MUST_ESCAPE + "?#/";
        ...
        // this.
        protected static const baselineExclude:URIEncoding =  new URIEncoding( BASELINE_ESCAPE );
        
        // Scheme escaping bitmap
        protected static const schemeExclude:URIEncoding = baselineExclude;
        
        // User/pass escaping bitmap
        protected static const userpassExclude:URIEncoding = baselineExclude;
        
        // Authority escaping bitmap
        protected static const authorityExclude:URIEncoding = baselineExclude;
            
        // Port escaping bitmap
        protected static const portExclude:URIEncoding =  baselineExclude;
        
        // Path escaping bitmap
        protected static const pathExclude:URIEncoding = new URIEncoding( PATH_ESCAPE );
            
        // Query (whole) escaping bitmap
        protected static const queryExclude:URIEncoding = new URIEncoding( QUERY_ESCAPE );
            
        // Query (individual parts) escaping bitmap
        protected static const queryPartExclude:URIEncoding = new URIEncoding( QUERY_PART_ESCAPE );
            
        // Fragments are the last part in the URI.  They only need to
        // escape space, '#', and '%'.  Turns out that is what query
        // uses too.
        protected static const fragmentExclude:URIEncoding = queryExclude;
            
        // Characters that need to be escaped in the non-hierarchical part
        protected static const nonhierExclude:URIEncoding = new URIEncoding( NON_HIERARCHICAL_ESCAPE );
        ...
        protected static var _resolver:URIResolver = null;
        ...
        */
        ...
        protected function validateURI():Boolean
        {
            ...
            if( hierState )
            {
                ...
                else if( (isRelative() == false) && (_scheme == UNKNOWN) )
                {
         ...
         * otherwise.
         */
        public function isValid():Boolean { return this._valid; }
         ...
         */
        public function isAbsolute():Boolean { return !this._relative;}
         ...
         */
        public function isRelative():Boolean { return this._relative; }
         ...
         */
        public function isHierarchical():Boolean { return hierState;}
        
        /**
         * The scheme of the URI.
         */
        public function get scheme():String { return URI.unescapeChars( _scheme ); }
        /** @private */
        public function set scheme( schemeStr:String ):void
        {
            // Normalize the scheme
            var normalized:String = schemeStr.toLowerCase();
            _scheme = URI.fastEscapeChars( normalized, URI.schemeExclude );
        }
         ...
         */
        public function get authority():String { return URI.unescapeChars( _authority ); }
        /** @private */
        public function set authority( authorityStr:String ):void
        {
            ...
            _authority = URI.fastEscapeChars( authorityStr, URI.authorityExclude );
         ...
         */
        public function get username():String { return URI.unescapeChars( _username ); }
        /** @private */
        public function set username( usernameStr:String ):void
        {
            _username = URI.fastEscapeChars( usernameStr, URI.userpassExclude );
         ...
         * @see URI.username
         */
        public function get password():String { return URI.unescapeChars( _password ); }
        /** @private */
        public function set password( passwordStr:String ):void
        {
            _password = URI.fastEscapeChars( passwordStr, URI.userpassExclude );
         ...
         */
        public function get port():String { return URI.unescapeChars( _port ); }
        /** @private */
         ...
         * </listing>
         */
        public function get path():String { return URI.unescapeChars( _path ); }
        /** @private */
        public function set path( pathStr:String ):void
        {   
            this._path = URI.fastEscapeChars( pathStr, URI.pathExclude );
         ...
         */
        public function get query():String { return URI.unescapeChars( _query ); }
        /** @private */
        public function set query( queryStr:String ):void
        {
            _query = URI.fastEscapeChars( queryStr, URI.queryExclude );
         ...
         */
        public function get queryRaw():String { return _query; }
        /** @private */
        public function set queryRaw( queryStr:String ):void { _query = queryStr; }
        
        /**
         * The fragment (anchor) portion of the URI.  This is valid for
         * both hierarchical and non-hierarchical URI's.
         */
        public function get fragment():String { return URI.unescapeChars( _fragment ); }
        /** @private */
        public function set fragment( fragmentStr:String ):void
        {
            _fragment = URI.fastEscapeChars( fragmentStr, fragmentExclude );
         ...
         */
        public function get nonHierarchical():String { return URI.unescapeChars( _nonHierarchical ); }
        /** @private */
        public function set nonHierarchical( nonHier:String ):void
        {
            _nonHierarchical = URI.fastEscapeChars( nonHier, nonhierExclude );
        ...
        public function setParts( schemeStr:String, authorityStr:String,
                                  portStr:String, pathStr:String,
                                  queryStr:String, fragmentStr:String ):void
        {
        ...
        static public function escapeChars( unescaped:String ):String
        {
            ...
            return fastEscapeChars( unescaped, URI.baselineExclude );
        }
         ...
         */
        static public function fastEscapeChars( unescaped:String, bitmap:URIEncoding ):String
        {
            var escaped:String = "";
            var c:String;
            var x:int, i:int;
        ...
        static public function queryPartEscape( unescaped:String ) : String
        {
            ...
            escaped = URI.fastEscapeChars( unescaped, URI.queryPartExclude );
            return escaped;
        }
         ...
         */
        static protected function compareStr( str1:String, str2:String, sensitive:Boolean = true ):Boolean
        {
            if( sensitive == false )
            {
         ...
         */
        static public function get resolver():URIResolver { return _resolver; }
        /** @private */
        static public function set resolver( resolver:URIResolver ):void { _resolver = resolver; }
